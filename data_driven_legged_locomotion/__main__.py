...
mujoco_mpc_service_forward = MujocoMPCService(ss, model, direction=np.array([1.0, 0.0]))
mujoco_mpc_service_right = MujocoMPCService(ss, model, direction=np.array([0.0, 1.0]))
